...
const routes = [
  ...
  { path: '/cotizador?preset=ags-individual&autoAdvance=true', tag: '@ags-individual', heading: 'Cotizador de Soluciones' },
  { path: '/cotizador?preset=edomex-colectivo&autoAdvance=true', tag: '@edomex-colectivo', heading: 'Cotizador de Soluciones' },
