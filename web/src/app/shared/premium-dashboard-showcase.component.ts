...
import { HumanMicrocopyService } from '@feature-services/experience/human-microcopy.service';
...
export class PremiumDashboardShowcaseComponent implements OnInit {
  ...
  triggerPaymentSuccess(): void {
    ...
    timer(2000)
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe(() => this.paymentSuccessTriggered.set(false));
  }
  ...
  triggerContractSigning(): void {
    ...
    timer(1500)
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe(() => this.contractSignedTriggered.set(false));
  }
  ...
  triggerKYCVerification(): void {
    ...
    timer(3000)
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe(() => this.kycVerifiedTriggered.set(false));
  }
