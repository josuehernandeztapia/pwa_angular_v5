...
export class SavingsProjectionChartComponent implements OnChanges {
  ...
  get completeColor(): string {
    return this.tokensService.dataColor('secondary'); // Green for completed goals
  }

  get progressColor(): string {
    return this.tokensService.dataColor('primary'); // Blue for progress
  }

  get hoverColor(): string {
    return this.tokensService.dataColor('accent'); // Cyan for hover states
  }
