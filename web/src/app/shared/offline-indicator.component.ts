import { Component, DestroyRef, OnDestroy, computed, signal, inject } from '@angular/core';
  ...
  constructor(
    ...
    this.offlineService.online$
      ...
      if (!isOnline) {
        ...
        this.expanded.set(true);
        // Auto-dismiss after 3 segundos si no hay pendientes
        this.autoDismissSubscription?.unsubscribe();
        this.autoDismissSubscription = timer(3000)
          .pipe(takeUntilDestroyed(this.destroyRef))
          .subscribe(() => {
