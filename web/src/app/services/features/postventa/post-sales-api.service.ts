...
import { PostSalesMockAdapter } from '@internal-services/mock-adapters/post-sales-mock.adapter';
import {
  PostSalesRecord,
  PostSalesService,
  PostSalesContact,
...
export class PostSalesApiService {
  ...
  private readonly mock = inject(PostSalesMockAdapter);
  private readonly baseUrl = resolveBffBaseUrl();
  private readonly useMock = environment.features.enableMockData;
  ...
  sendVehicleDeliveredEvent(event: VehicleDeliveredEvent): Observable<{
    ...
    if (this.useMock) {
      return this.mock.sendVehicleDeliveredEvent(event);
    }
  ...
  getPostSalesRecord(vin: string): Observable<{
    ...
    if (this.useMock) {
      return this.mock.getPostSalesRecord(vin);
    }
  ...
  getClientPostSalesRecords(clientId: string): Observable<PostSalesRecord[]> {
    if (this.useMock) {
      return this.mock.getClientPostSalesRecords(clientId);
    }
  ...
  updatePostSalesRecord(vin: string, updates: Partial<PostSalesRecord>): Observable<{
    ...
    if (this.useMock) {
      return this.mock.updatePostSalesRecord(vin, updates);
    }
  ...
  registerService(vin: string, serviceData: {
    ...
    if (this.useMock) {
      return this.mock.registerService(vin, serviceData);
    }
    return this.http.post<{
      success: boolean;
      service?: PostSalesService;
  ...
  getServiceHistory(vin: string, filters?: {
    ...
    if (this.useMock) {
      return this.mock.getServiceHistory(vin, filters);
    }
  ...
  getMaintenanceReminders(vin: string): Observable<MaintenanceReminder[]> {
    if (this.useMock) {
      return this.mock.getMaintenanceReminders(vin);
    }
  ...
  scheduleMaintenanceReminder(vin: string, reminderData: {
    ...
    if (this.useMock) {
      return this.mock.scheduleMaintenanceReminder(vin, reminderData);
    }
    return this.http.post<{
      success: boolean;
      reminder?: MaintenanceReminder;
  ...
  getUpcomingReminders(filters?: {
    ...
    if (this.useMock) {
      return this.mock.getUpcomingReminders(filters);
    }
    let params = new HttpParams();
  ...
  sendSurvey(data: {
    ...
    if (this.useMock) {
      return this.mock.sendSurvey(data);
    }
    return this.http.post<{
      success: boolean;
      contactId?: string;
  ...
  registerContact(vin: string, contactData: {
    ...
    if (this.useMock) {
      return this.mock.registerContact(vin, contactData);
    }
    return this.http.post<{
      success: boolean;
      contact?: PostSalesContact;
  ...
  getContactHistory(vin: string, filters?: {
    ...
    if (this.useMock) {
      return this.mock.getContactHistory(vin, filters);
    }
    let params = new HttpParams();
  ...
  processSurveyResponse(vin: string, response: {
    ...
    if (this.useMock) {
      return this.mock.processSurveyResponse(vin, response);
    }
    return this.http.post<{
      success: boolean;
      surveyResponse?: PostSalesSurveyResponse;
  ...
  getSurveyAnalytics(filters?: {
    ...
    if (this.useMock) {
      return this.mock.getSurveyAnalytics(filters);
    }
    let params = new HttpParams();
  ...
  createWarrantyTicket(data: {
    ...
    if (this.useMock) {
      return this.mock.createWarrantyTicket(data);
    }
    return this.http.post<{
      success: boolean;
      ticketId?: string;
  ...
  getWarrantyStatus(vin: string): Observable<{
    ...
    if (this.useMock) {
      return this.mock.getWarrantyStatus(vin);
    }
    return this.http.get<{
      isActive: boolean;
      warrantyStart: Date;
  ...
  getVehicleRevenue(vin: string): Observable<PostSalesRevenue | null> {
    if (this.useMock) {
      return this.mock.getVehicleRevenue(vin);
    }
  ...
  getPostSalesKPIs(filters?: {
    ...
    if (this.useMock) {
      return this.mock.getPostSalesKPIs();
    }
    let params = new HttpParams();
    if (filters?.startDate) params = params.set('startDate', filters.startDate.toISOString());
    if (filters?.endDate) params = params.set('endDate', filters.endDate.toISOString());
  ...
  getLTVAnalytics(filters?: {
    ...
    if (this.useMock) {
      return this.mock.getLTVAnalytics();
    }
    let params = new HttpParams();
    if (filters?.servicePackage) params = params.set('servicePackage', filters.servicePackage);
  ...
  scheduleMaintenanceService(request: {
    ...
    if (this.useMock) {
      return this.mock.scheduleMaintenanceService(request);
    }
    return this.http.post<{
      success: boolean;
      serviceId?: string;
  ...
  recordClientContact(contact: {
    ...
    if (this.useMock) {
      return this.mock.recordClientContact(contact);
    }
    return this.http.post<{
      success: boolean;
      contactId?: string;
